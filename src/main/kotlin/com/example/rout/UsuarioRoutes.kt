    ...
    route("/usuario") {
        ...
        post("/login") {
            try {
                ...
                // Llamar a la función loginConCargo
                val (usuario, cargo) = dao.loginConCargo(
                    nombreUsuario = loginRequest.nombreUsuario,
                    contrasena = loginRequest.contrasena
                )

                if (usuario != null) {
                    // Construir la respuesta incluyendo el usuario y su cargo
                    call.respond(
                        HttpStatusCode.OK,
                        LoginResponse(
                    ...
                    // Responder con credenciales incorrectas
                ...
                call.respond(
                    ...
                    mapOf("error" to "Error al intentar iniciar sesión: ${e.message}")
                )
            }
        }
